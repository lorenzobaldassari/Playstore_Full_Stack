...
//import LorenzoBaldassari.Playstore.Exceptions.UnauthorizedException;
...
//
//	public String createToken(Videogames videogame) {
//		return Jwts.builder().subject(String.valueOf(videogame.getId())) // Subject <-- A chi appartiene il token (id dell'utente)
